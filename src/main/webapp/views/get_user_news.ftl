...
<div class="divider"></div>
    ...
    <#list feed as feed_item>
        <div style="height: 0"><button style="margin: 0; float:right; font-size: 20px; background: none; border: none;" id="${feed_item.getId()}" onclick="deleteFeedItem(this.id)">x</button></div>
